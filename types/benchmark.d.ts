...
declare function suite(name: string, fn: () => void, options?: Benchmark.Options): void;
declare function benchmark(name: string, fn: () => void, options?: Benchmark.Options): void;
